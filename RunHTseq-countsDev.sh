...
cd /media/liz/ACERDATA/Elizabeth_DATA/

# Count all reads in CDS:
/usr/bin/python -m HTSeq.scripts.count --format=bam --stranded=no --type=CDS --idattr=Parent --mode=union ./BAM_sorted/2nst0_1s.bam ./features/exon.gff > 2nst0_1cds.counts
/usr/bin/python -m HTSeq.scripts.count --format=bam --stranded=no --type=CDS --idattr=Parent --mode=union ./BAM_sorted/2nst0_2s.bam ./features/exon.gff > 2nst0_2cds.counts
/usr/bin/python -m HTSeq.scripts.count --format=bam --stranded=no --type=CDS --idattr=Parent --mode=union ./BAM_sorted/2nst0_3s.bam ./features/exon.gff > 2nst0_3cds.counts
/usr/bin/python -m HTSeq.scripts.count --format=bam --stranded=no --type=CDS --idattr=Parent --mode=union ./BAM_sorted/3nst0_1s.bam ./features/exon.gff > 3nst0_1cds.counts
/usr/bin/python -m HTSeq.scripts.count --format=bam --stranded=no --type=CDS --idattr=Parent --mode=union ./BAM_sorted/3nst0_2s.bam ./features/exon.gff > 3nst0_2cds.counts
/usr/bin/python -m HTSeq.scripts.count --format=bam --stranded=no --type=CDS --idattr=Parent --mode=union ./BAM_sorted/3nst0_3s.bam ./features/exon.gff > 3nst0_3cds.counts
/usr/bin/python -m HTSeq.scripts.count --format=bam --stranded=no --type=CDS --idattr=Parent --mode=union ./BAM_sorted/3nst3fa_1s.bam ./features/exon.gff > 3nst3fa_1cds.counts
/usr/bin/python -m HTSeq.scripts.count --format=bam --stranded=no --type=CDS --idattr=Parent --mode=union ./BAM_sorted/3nst3fa_2s.bam ./features/exon.gff > 3nst3fa_2cds.counts
/usr/bin/python -m HTSeq.scripts.count --format=bam --stranded=no --type=CDS --idattr=Parent --mode=union ./BAM_sorted/3nst3fa_3s.bam ./features/exon.gff > 3nst3fa_3cds.counts
/usr/bin/python -m HTSeq.scripts.count --format=bam --stranded=no --type=CDS --idattr=Parent --mode=union ./BAM_sorted/3nst3fb_1s.bam ./features/exon.gff > 3nst3fb_1cds.counts
/usr/bin/python -m HTSeq.scripts.count --format=bam --stranded=no --type=CDS --idattr=Parent --mode=union ./BAM_sorted/3nst3fb_2s.bam ./features/exon.gff > 3nst3fb_2cds.counts
/usr/bin/python -m HTSeq.scripts.count --format=bam --stranded=no --type=CDS --idattr=Parent --mode=union ./BAM_sorted/3nst3fb_3s.bam ./features/exon.gff > 3nst3fb_3cds.counts
/usr/bin/python -m HTSeq.scripts.count --format=bam --stranded=no --type=CDS --idattr=Parent --mode=union ./BAM_sorted/3nst23ma_1s.bam ./features/exon.gff > 3nst23ma_1cds.counts
/usr/bin/python -m HTSeq.scripts.count --format=bam --stranded=no --type=CDS --idattr=Parent --mode=union ./BAM_sorted/3nst23ma_2s.bam ./features/exon.gff > 3nst23ma_2cds.counts
/usr/bin/python -m HTSeq.scripts.count --format=bam --stranded=no --type=CDS --idattr=Parent --mode=union ./BAM_sorted/3nst23ma_3s.bam ./features/exon.gff > 3nst23ma_3cds.counts
/usr/bin/python -m HTSeq.scripts.count --format=bam --stranded=no --type=CDS --idattr=Parent --mode=union ./BAM_sorted/3nst23mb_1s.bam ./features/exon.gff > 3nst23mb_1cds.counts
/usr/bin/python -m HTSeq.scripts.count --format=bam --stranded=no --type=CDS --idattr=Parent --mode=union ./BAM_sorted/3nst23mb_2s.bam ./features/exon.gff > 3nst23mb_2cds.counts
/usr/bin/python -m HTSeq.scripts.count --format=bam --stranded=no --type=CDS --idattr=Parent --mode=union ./BAM_sorted/3nst23mb_3s.bam ./features/exon.gff > 3nst23mb_3cds.counts
