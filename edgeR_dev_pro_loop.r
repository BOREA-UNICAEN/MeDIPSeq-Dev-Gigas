...
# Set the proxy address so that R can access the internet.
#Sys.setenv(http_proxy="http://proxy.unicaen.fr:3128/")
#Load the edgeR package.
library("edgeR")
#Get the list of counts files to process.
#setwd("/media/liz/ACERDATA/Elizabeth_DATA/counts_dev/cds")
setwd("counts_dev/pro")
...
# Remove ovo3 from targets (only for this feature!):
